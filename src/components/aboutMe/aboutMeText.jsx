...
const AboutMeText = () => {
  return (
    <motion.div 
     ...
     >
       <button 
         className='bg-lightBrown border-orange/25 border-[1px] w-40 rounded-full hover:text-white hover:scale-110 transition-all duration-500 h-12 cursor-pointer'
       >
         My Projects
       </button>
     </Link>
